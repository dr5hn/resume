# Darshan Gada
_AI Engineer, Technical Innovation Leader & Open Source Contributor based in Mumbai, India_ <br>
...
**Head of AI & Innovations** @ [SOZO Design](https://sozodesign.co.uk/) _(Feb 2021 - Present)_<br>
Award-winning digital agency based in Cheltenham and London, serving clients across the UK for 20+ years.
...
* Led a team of 5 (2 Backend, 2 Frontend, 1 Mobile) with full responsibility for architecture, code reviews, and deployments
* Saved 15% of team effort through GitHub Actions automation (reviewer assignments, build tests, labelling, linting, deployments)
...
- [csc-org-website](https://github.com/dr5hn/csc-org-website) - Geographic encyclopedia built on the CSC dataset. Built with Next.js 16, React 19, Tailwind CSS, Lucide Icons.
...
- [server-setup](https://github.com/dr5hn/server-setup) - Server setup guide for Ubuntu (NginX, Apache, MySQL, PHP, Node.js, MongoDB, Redis, PM2, Certbot)
